...
// Check if the user is logged in as an admin, and ensure post_id is provided in the URL
...
<head>
    ...
    <!-- Include necessary stylesheets and JavaScript libraries -->
...
<body>
    <?php 
    // Include side navigation and database connection files
    $key = "hhdsfs1263z";
    ...
    // Fetch the post details by post_id and all categories from the database
    ...
    <div class="main-table">
        ...
        <form class="shadow p-3" 
            ...
            <div class="mb-3">
                ...
                <!-- Hidden fields to store post_id and current cover_url -->
                <input type="text" 
                       class="form-control"
                       name="post_id"
                       value="<?=$post['post_id']?>" 
    ...
    <script>
        ...
        // Initialize the rich text editor for the textarea
